 <div class="sidebar-menu">
    ...
    <a href="#" class="sidebar-icon"> <span class="fa fa-bars"></span> </a> <a href="dashboard.php"> <span id="logo"> <img src="https://imgur.com/b87Yw8H.png" alt="MCO Logo" style="width: 55%; margin-left: -10%; margin-top: -11%"></span> 
